                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="breadcaump-inner text-center">
                            <h2 class="heading heading-h2 font-60 text-white">Plata y Bronce en el Salón del Queso 2024</h2>
                        </div>
                    </div>
                </div>
            </div>
                                ...
                                <article class="blog-post standard-post">
                                    ...
                                    <div class="header mb--40 text-center">
                                        ...
                                        <div class="post-meta mt--20">
                                            <div class="post-date text-white">Ago 28, 2024</div>
                                            <div class="post-category"><a class="text-white" href="#">Categoría</a></div>
                                        </div>
                                    </div>
                                    <!-- Start Thumbnail -->
                                    ...
                                    <div class="content basic-dark2-line-1px pb--50 mb--35">
                                        <div class="inner">
                                            <h5 class="heading heading-h5 line-height-1-95 text-white wow move-up">Desde el Salón del Queso, el Caquetá con La Maporita en el corazón del evento. El pasado domingo 18 de agosto se eligió el mejor queso del año y el mejor arequipe, tras una rigurosa evaluación entre 70 quesos de 22 empresas de todo el país.</h5>
                                            <div class="desc mt--45 mb--50">
                                                <p class="bk_pra text-white wow move-up">
                                                Bogotá se convirtió en la capital del sabor colombiano con la celebración de la XI edición del Premio Nacional del Queso y la VIII edición del Premio Nacional del Arequipe. Este emocionante evento tuvo lugar en el Centro Comercial Paseo San Rafael. <br><br>
Industria de Lácteos La Maporita logró dos importantes premios este año, Medalla de Plata en la modalidad Cuajada Pasteurizada y Medalla de Bronce en pasta hilada de Quesillo. Este año, las distinciones fueron recibidas por José Humberto Maya Montoya, propietario de La Maporita.<br><br>
"Infinitas gracias Padre Celestial, un triunfo para el Caquetá, tierra donde el oro es verde". Es importante resaltar que este premio no le pertenece solo a la empresa, sino a toda la cadena de valor, ya que La Maporita viene trabajando con los proveedores para conservar este tesoro verde donde se desarrolla la ganadería sostenible que le da el verdadero valor y calidad a los productos. Seguiremos trabajando con calidad y mucho amor, para dejar en alto el nombre de nuestra tierra caqueteña.
                                                </p>
                                            </div>
                                        </div>
                                    </div>
