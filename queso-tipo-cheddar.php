                        ...
                        <div class="nextprev-btn">
                            <div class="navlist">
                                <div class="navitem prev">
                                    <a id="backLink" class="text-white" href="queso-picado-salado.php">Anterior</a>
                                </div>
                                <div class="navitem next">
                                    <a id="nextLink" class="text-white" href="queso-finas-hierbas.php">Siguiente</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12 col-12 mt_sm--40">
                        <div class="single-product-details-side">
                            <div class="product-details">
                                <div class="inner">
                                    <div class="header">
                                        <h4 class="heading heading-h4 text-white">Queso Tipo Cheddar</h4>
                                    </div>
                                    <!--
                                    <div class="price">
                                    ...
                                    <div class="description">
                                        <p class="bk_pra text-white">Descripción queso tipo cheddar
