...
$nombre_producto = "Queso Tipo Cheddar";
$titulo_producto = "Queso Tipo Cheddar La Maporita";
$descripcion_producto = "Queso fresco, graso de color amarillo intenso, con sabor particular similar al del tipo americano, no madurado de pasta hilada; su elasticidad y fácil gratinado lo hacen ideal para la preparación de comidas rápidas. Producto listo para el consumo.";
$presentaciones_producto = "40g, 125g, 250g, 450g, 500g y bloque de 2500g. Entero - Tajado.";
$rs_pdto = "RSA-0031470-2024";
$normatividad_pdto = "NTC - 750 <br> Resolución 1804 de 1989<br>Resolución 2310 de 1986";
$generalidades_pdto = "Queso fresco, no madurado de pasta hilada, elaborado a partir de la coagulación de la leche entera y fresca por la acción del cuajo y del suero ácido.";
...
$compos_pdto = "Leche entera, lactosuero (fermento láctico), sal (cloruro de sodio), estabilizante (citrato de sodio), saborizante (idéntico al natural), colorante natural (annato) y enzima (cuajo).";
...
$proces_alab_pdto = "1. Recepción y filtrado de la leche fresca de vaca entera.<br>2. Pruebas de plataforma a la leche, según el Decreto 616 de 2006.<br>3. Estandarización de la acidez, calculando las cantidades de leche fresca y suero ácido mediante el método de cuadrado de Pearson, para obtener una mezcla con acidez de 45 ºD.<br>4. Adición de cuajo, reposo por 10 minutos y aplicación del suero ácido lentamente.<br>5. Corte de la cuajada en cuadros de 10 cm x 10 cm.<br>6. Desuerado y recolección de la cuajada.<br>7. Maduración de la cuajada por 15 minutos sobre la mesa de trabajo.<br>8. Hilado con calentamiento hasta formar una pasta elástica, firme y lisa. En esta etapa se adicionan la sal, el citrato, el color y el sabor.<br>9. Moldeo y empaque.";
...
<head>
    ...
    <title>Queso Tipo Cheddar || Industria de Lácteos, La Maporita</title>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="breadcaump-inner text-center">
                            <h2 class="heading heading-h2 font-60 text-white">Queso Tipo Cheddar</h2>
                        </div>
                    </div>
                </div>
            </div>
