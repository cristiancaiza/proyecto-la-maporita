<?php
$blog_post = [
    'title' => 'Importante para nuestros proveedores: Descarga el Manual de Proveedores y el Sistema de Pago de Leche Cruda',
    'date' => 'Abril 02, 2025',
    'category' => 'Categoría',
    ...
    'content' => '<strong>Introducción:</strong><br>
    En La Maporita, valoramos el compromiso y la dedicación de nuestros proveedores de leche. Para facilitar su trabajo y brindarles mayor transparencia en nuestros procesos, ponemos a su disposición dos documentos esenciales: el Manual de Proveedores y el Sistema de Pago de Leche Cruda.
    <br><br><strong>Manual de Proveedores:</strong><br>
    Este documento detalla los requisitos, estándares de calidad y buenas prácticas que deben seguir los proveedores de leche para garantizar un producto de alta calidad. Además, encontrarán información sobre los beneficios que ofrecemos y el acompañamiento técnico disponible.
...
Descargar Sistema de Pago de Leche Cruda (este sería el link de descarga)
    '
];
