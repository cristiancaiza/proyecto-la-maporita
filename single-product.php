...
<head>
    ...
    <title>Single Product || Brook Multipurpose Bootstrap4 Template</title>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                        <div class="single-product-left-side">
                            ...
                            <div class="single-big-thumbnail">
                                <div class="image">
                                    <img class="w-100" src="img/product/md-image/single-product-1.jpg" alt="product image">
                                </div>
                            </div>

                            <div class="single-big-thumbnail mt--20">
                                <div class="image">
                                    <img class="w-100" src="img/product/md-image/single-product-2.jpg" alt="product image">
                                </div>
                            </div>

                            <div class="single-big-thumbnail mt--20">
                                <div class="image">
                                    <img class="w-100" src="img/product/md-image/single-product-3.jpg" alt="product image">
                                </div>
                            </div>
                                ...
                                <div class="inner">
                                    ...
                                    <div class="quenty-container">
                                        ...
                                        <div class="product-action">
                                            <a class="addtocart" href="cart.html"><i class="fas fa-shopping-bag"></i><span>Add
                                                    to cart</span></a>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="description_nav nav nav-tabs d-block" role="tablist">
                                <a class="active" id="descrip-tab" data-bs-toggle="tab" href="#descrip" role="tab"
                                    aria-controls="descrip" aria-selected="true">Description</a>
                                <a id="nav-review" data-bs-toggle="tab" href="#review" role="tab" aria-controls="review"
                            ...
                            <div class="classs__review__inner">
                                ...
                                <form action="#">
                                    ...
                                    <div class="submit__btn2 mt--30 text-center">
                                        <a class="brook-btn bk-btn-theme btn-sd-size btn-rounded space-between" href="#">Post
                                            Comment</a>
                                    </div>
                                </form>
                            </div>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="brook-section-title text-center">
                                <h3 class="heading heading-h3">Related Products</h3>
                            </div>
                        </div>
                    </div>
                    <div class="row mt--30">
                        ...
                        <div class="col-lg-4 mt--30 col-md-6 col-12">
                            <div class="product">
                                <div class="product-thumbnail">
                                    <div class="thumbnail">
                                        <div class="product-main-image">
                                            <img src="img/product/md-image/product-1.jpg" alt="Multipurpose">
                                        </div>
                                        <div class="product-hover-image">
                                            <img src="img/product/md-image/product-2.jpg" alt="Multipurpose">
                                        </div>
                                        <div class="product-badges">
                                ...
                                <div class="product-info">
                                    <h5 class="heading heading-h5"><a href="#">Metallic Silver Serving
                                            Skillets</a></h5>
                                    <ul class="rating">
