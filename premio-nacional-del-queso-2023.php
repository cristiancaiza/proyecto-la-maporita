<?php
$blog_post = [
    'title' => 'Premio Nacional del Queso 2023',
    'date' => 'Noviembre 18, 2023',
    'category' => 'Categoría',
    'image' => 'img/novedades/grandes/premio-nacional-del-queso-2023-g.jpg',
    'alt' => 'Premio Nacional del Queso 2023',
    'description' => 'Industria de Lácteos La Maporita celebra el reconocimiento a la calidad en cada etapa de su cadena de valor, destacando a los proveedores comprometidos con la conservación y buenas prácticas ganaderas.',
    'content' => '
        El pasado 12 de noviembre se llevó a cabo en el Centro Comercial San Rafael en Bogotá, la décima versión del Premio Nacional Del Queso - CNLM® 2023, en el marco del Salón del Queso del grupo Éxito Carulla. Este evento busca promover los productos nacionales, en especial los quesos frescos, semimaduros y maduros colombianos.
        <br><br>Nuestra familia Maporita fue una de las 21 empresas participantes, obteniendo medalla de plata con una puntuación de 94 como producto Calidad Extra en la categoría 2 de Quesos de pasta Hilada I /tipo Mozzarella, Doble crema, Quesillo.
