<?php
$blog_post = [
    'title' => 'Nueva imagen de empaques',
    'date' => 'Diciembre 21, 2022',
    'category' => 'Categoría',
    'image' => 'img/novedades/grandes/nueva-imagen-de-empaques-g.jpg',
    'alt' => 'Nueva imagen de empaques',
    'description' => 'El pasado 17 de diciembre, Industria de Lácteos La Maporita, llevó a cabo el lanzamiento de la nueva imagen de sus empaques. Al final, se realizó un sorteo entre los asistentes, cuyo premio sorprendió a todos.',
    'content' => '
        El pasado 17 de diciembre, Industria de Lácteos La Maporita, llevó a cabo el lanzamiento de la nueva imagen de sus empaques.
        <br><br>El evento tuvo lugar en la ciudad de Cali, en el salón momentos, en la Martina Restaurante.
        <br><br>Se contó con la asistencia de algunos de los clientes de la familia Maporita en la ciudad de Cali, como restaurantes y salsamentarias. Se disfrutó una deliciosa tabla de quesos; al final, se realizó un sorteo entre los asistentes, cuyo premio sorprendió a todos, ya que los ganadores realizarán una Ruta del Queso con todo pago para dos personas, donde podrán conocer desde sus orígenes todo el proceso de la cadena de valor de cada producto elaborado por la empresa.
        <br><br>Industria de Lácteos La Maporita, una empresa caqueteña, siempre dándote lo mejor, con calidad y mucho amor.
        <br><br><iframe width="560" height="315" src="https://www.youtube.com/embed/yjDvx-nSJnY?si=me5MAHC6RLjuOf4K" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
    '
];
?>
