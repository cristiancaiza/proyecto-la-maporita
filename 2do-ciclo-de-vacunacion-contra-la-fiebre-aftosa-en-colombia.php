                            ...
                            <div class="blog-details-wrapper">
                                <article class="blog-post standard-post">
                                    ...
                                    <div class="content basic-dark2-line-1px pb--50 mb--35">
                                        <div class="inner">
                                            <h5 class="heading heading-h5 line-height-1-95 text-white wow move-up">El 28 de octubre inicia en Colombia el segundo ciclo de vacunación contra fiebre aftosa, brucelosis bovina y rabia silvestre, liderado por el ICA y Fedegan para fortalecer la sanidad ganadera.</h5>
                                            <div class="desc mt--45 mb--50">
                                                <p class="bk_pra text-white wow move-up">
                                                El 28 de octubre inicia el segundo ciclo de vacunación de 2024 en Colombia contra la fiebre aftosa, brucelosis bovina y rabia de origen silvestre. El objetivo es vacunar a aproximadamente 29,7 millones de bovinos y bufalinos en más de 616,000 predios en todo el país. Este esfuerzo, coordinado por el ICA y Fedegan, involucra a más de 6,000 personas, incluidas 83 organizaciones ejecutoras, y durará 50 días.<br><br>
