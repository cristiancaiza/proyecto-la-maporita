...
$nombre_producto = "Queso Finas Hierbas";
$titulo_producto = "Queso Finas Hierbas La Maporita";
$descripcion_producto = "Queso fresco de pasta hilada con la combinación del sabor y aroma dado por la mezcla de hierbas deshidratadas. Producto listo para el consumo, ideal para acompañar sándwiches, ensaladas y vinos.";
...
$generalidades_pdto = "Queso de pasta hilada, adicionado de especias deshidratadas.";
...
$compos_pdto = "Leche entera fresca, lactosuero (fermento láctico), cloruro de sodio (sal de mesa), estabilizante (citrato de sodio), hierbas finas deshidratadas (laurel, albahaca, orégano, tomillo, perejil, romero y manzanilla) y enzima (cuajo).";
...
$proces_alab_pdto = "1. Recepción y filtrado de la leche fresca de vaca entera.<br>2. Pruebas de plataforma a la leche, según el Decreto 616 de 2006.<br>3. Estandarización de la acidez, calculando las cantidades de leche fresca y suero ácido mediante el método de cuadrado de Pearson, para obtener una mezcla con acidez de 45 ºD.<br>4. Adición de cuajo y suero ácido lentamente.<br>5. Corte de la cuajada en cuadros de 10 cm x 10 cm.<br>6. Desuerado y recolección de la cuajada.<br>7. Maduración de la cuajada por 15 minutos.<br>8. Hilado mediante calentamiento hasta formar una pasta elástica, firme y lisa. En esta etapa se adicionan la sal, el citrato y las hierbas finas deshidratadas.<br>9. Moldeo y empaque.";
...
<head>
    ...
    <title>Queso Finas Hierbas || Industria de Lácteos, La Maporita</title>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="breadcaump-inner text-center">
                            <h2 class="heading heading-h2 font-60 text-white">Queso Finas Hierbas</h2>
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <div class="product__details__container">
                                <div class="tab_container big_img_container">
                                    <div class="big_img tab-pane fade show active" id="img1" role="tabpanel">
                                        <img class="w-100" src="img/productos/grandes/760-x-760-finas-hierbas.jpg" alt="Queso Finas Hierbas">
                                    </div>
                                </div>
