<?php
$blog_post = [
    'title' => 'Preferencias frente al consumo de Queso en Cali y ciudades cercanas',
    'date' => 'Julio 05, 2022',
    'category' => 'Categoría',
    'image' => 'img/novedades/grandes/preferencias-frente-al-consumo-de-queso-en-cali-y-ciudades-cercanas-g.jpg',
    'alt' => 'Preferencias frente al consumo de Queso en Cali y ciudades cercanas',
    'description' => '¿Estás en Cali? Contesta unas preguntas y participa por un Bono que podrás redimir en comidas rápidas.',
    'content' => '
        A continuación, presentamos el link al formulario donde podrá participar de este estudio sobre las Preferencias frente al consumo de Queso y/o productos con Queso en la ciudad de Cali y ciudades cercanas.
        <br><br>El presente estudio busca conocer las preferencias frente al consumo de Queso o productos que lo lleven en su preparación en la ciudad de Cali y ciudades cercanas. Este formulario recopila la información del correo electrónico únicamente para limitar la participación de cada persona. Solo se podrá participar una sola vez. Al final de este formulario, usted podrá participar en un sorteo por un premio, como agradecimiento a su colaboración en este estudio. También podrá decidir si quiere recibir más información o no.
        <br><br>Gracias, y le damos la bienvenida a este formulario.
        <br><br>Estudio Realizado por Cristian Osorio, GAMagencia & ClüPRINT para la empresa Industria de Lácteos La Maporita SAS con el apoyo de la Cámara de Comercio de Florencia.
        <br><br> <a class="enlace-blog" href="https://forms.gle/qR8stfdraaPdfuVG6" target="_blank">Clic aquí para ir al formulario</a>
    '
];
?>
