  ...
  <![endif]-->
    ...
    <div id="wrapper" class="wrapper">
        ...
        <main class="page-content">
            ...
            <div class="bk-carousel-slider bg_color--1 ptb--150 slick-arrow-hover ptb-md--80 ptb-sm--60">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            {"breakpoint":590, "settings": {"slidesToShow": 1}}
                                ...
                                <div class="carousle-slider text-center">
                                    <div class="thumb">
                                        <img src="img/carousel/cat2-md-1.jpg" alt="Carousel Image">
                                    </div>
                                </div>
                                <!-- End Single Carousel -->
                                ...
                                <div class="carousle-slider text-center">
                                    <div class="thumb">
                                        <img src="img/carousel/cat2-md-2.jpg" alt="Carousel Image">
                                    </div>
                                </div>
                                <!-- End Single Carousel -->
                                ...
                                <div class="carousle-slider text-center">
                                    <div class="thumb">
                                        <img src="img/carousel/cat2-md-3.jpg" alt="Carousel Image">
                                    </div>
                                </div>
                                <!-- End Single Carousel -->
                                ...
                                <div class="carousle-slider text-center">
                                    <div class="thumb">
                                        <img src="img/carousel/cat2-md-4.jpg" alt="Carousel Image">
                                    </div>
                                </div>
                                <!-- End Single Carousel -->
                            ...
                            <div class="bk-accordion-style--2" id="accordionExampl3">
                                ...
                                <div class="card">
                                    <div class="card-header" id="headingseven">
                                        <h5 class="mb-0">
                                            <a href="#" class="acc-btn collapsed" data-bs-toggle="collapse" data-bs-target="#collapseseven"
                                ...
                                <div class="card">
                                    <div class="card-header" id="headingeight">
                                        <h5 class="mb-0">
                                            <a href="#" class="acc-btn collapsed" data-bs-toggle="collapse" data-bs-target="#collapeight"
