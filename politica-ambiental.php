                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-12 mt_sm--40 mt_md--40 texto-blanco">
                            <div class="bk-title--default text-start">
                                ...
                                <p class="bk_pra wow move-up">Tras este compromiso de mantener el equilibrio en el ecosistema y brindar a sus territorios oportunidades de desarrollo agroindustrial, orientamos la producción de nuestros proveedores de manera responsable, a través de:</p>
                            </div>
                            <div class="row">
                                <!-- Start Single -->
                                <div class="col-lg-6 col-md-6 col-12">
                                    <div class="what-do mt--30">
                                        <div class="content">
                                            ...
                                            <p class="bk_pra wow move-up">✓  Implementar un sistema de Gestión ambiental SGA que permita establecer una estructura ambiental encaminada a controlar y mitigar prácticas que puedan producir efectos negativos en el medio ambiente.</p>
                                        </div>
                                    </div>
                                </div>
                                <!-- End Single -->
                                ...
                                <div class="col-lg-6 col-md-6 col-12">
                                    <div class="what-do mt--30">
                                        <div class="content">
                                            <div class="bkseparator--20"></div>
                                            <p class="bk_pra wow move-up">✓ Una adecuada clasificación de los residuos, sensibilizando a todos los actores sobre la importancia de hacerlo.</p>
                                        </div>
                                    </div>
                                </div>
                                <!-- End Single -->
                                ...
                                <div class="col-lg-6 col-md-6 col-12">
                                    <div class="what-do mt--30">
                                        <div class="content">
                                            <div class="bkseparator--20"></div>
                                            <p class="bk_pra wow move-up">✓ Dar cumplimiento a las responsabilidades ambientales, enmarcadas en la legislación ambiental vigente en el país.</p>
                                        </div>
                                    </div>
                                </div>
                                <!-- End Single -->
                                ...
                                <div class="col-lg-6 col-md-6 col-12">
                                    <div class="what-do mt--30">
                                        <div class="content">
                                            <div class="bkseparator--20"></div>
                                            <p class="bk_pra wow move-up">✓ Sensibilizar a nuestro personal, proveedores, contratistas y clientes, sobre el compromiso con el medio ambiente, por medio de estrategias de concientización en el consumo de los recursos ambientales, al optimizar las acciones, generando mejoras y modernización en los equipos por modelos más eficientes.</p>
                                        </div>
                                    </div>
                                </div>
                                <!-- End Single -->
