                        ...
                        <li data-index="rs-16" data-transition="curtain-1,curtain-3,curtain-2" data-slotamount="default,default,default,default"
                            ...
                            <!-- LAYERS -->
                             ...
                             <div class="tp-caption   tp-resizeme" id="slide-16-layer-1" data-x="['center','center','center','center']"
                                ...
                                <span class="texto-slider-home" style="line-height: 1.5; font-size:40px; padding: 40px 0px 20px 0px; display: block;">un Reconocimiento</span><span class="texto-slider-home" style="line-height: 1.5; display:block; padding:20px 0px 0px 0px !important; font-weight:200; font-size: 25px">al esfuerzo de toda nuestra cadena de valor</span>
                            </div> <!---->
                            <!-- LAYER NR. 2 -->
