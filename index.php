...
$slide_src4 = "img/home/slider/slider4.jpg";
                ...
                <div id="rev_slider_8_1" class="rev_slider fullwidthabanner" style="display:none;" data-version="5.4.7">
                    <ul>
                        ...
                        <li data-index="rs-15" data-transition="curtain-1,curtain-3,curtain-2" data-slotamount="default,default,default,default"
                            ...
                            <!-- MAIN IMAGE   -->
                            <img src="<?= $slide_src4 ?>" alt="<?= $slide_alt4 ?>" data-bgposition="center center"
                                data-bgfit="cover" data-bgrepeat="no-repeat" class="rev-slidebg" data-no-retina>
                            <!-- LAYERS -->
                            <!-- LAYER NR. 2 -->

                            <!-- LAYER NR. 3  boton conocer mas-->
                            <a class="tp-caption rev-btn   smooth-scroll-link" href="acerca.php" target="_self" id="slide-16-layer-24"
                        ...
                        <li data-index="rs-16" data-transition="curtain-1,curtain-3,curtain-2" data-slotamount="default,default,default,default"
                            ...
                            <!-- LAYERS -->
                             ...
                             <div class="tp-caption   tp-resizeme" id="slide-16-layer-1" data-x="['center','center','center','center']"
                                ...
                                style="z-index: 6; min-width: 630px; max-width: 630px; white-space: normal; font-size: 0px; font-weight: 700; color: #ffffff; letter-spacing: 0px;"><span class="texto-slider-home" style="font-weight:200; font-size: 50%;">Cada medalla es</span>
                                <span class="texto-slider-home" style="font-size:7vw; padding: 40px 0px 20px 0px; display: block;">un Reconocimiento</span><span class="texto-slider-home" style="display:block; padding:20px 0px 0px 0px !important; font-weight:200; font-size: 50%;">al esfuerzo de toda nuestra cadena de valor</span>
                            </div> <!---->
                            <!-- LAYER NR. 2 -->
                        ...
                        <li data-index="rs-18" data-transition="incube,incube-horizontal,turnoff-vertical,turnoff"
                            ...
                            data-rotate="0,0,0,0" data-saveperformance="off" data-title="Slide" data-param1="04"
                            data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7=""
                            data-param8="" data-param9="" data-param10="" data-description="">
                            <!-- MAIN IMAGE -->
