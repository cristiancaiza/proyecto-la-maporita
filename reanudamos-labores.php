<?php
$blog_post = [
    'title' => 'Reanudamos Labores',
    'date' => 'Mayo 07, 2020',
    'category' => 'Categoría',
    'image' => 'img/novedades/grandes/reanudamos-labores-g.jpg',
    'alt' => 'Reanudamos Labores',
    'description' => 'Es importante para nosotros expresarle a todos nuestros clientes, proveedores y a la población en general, que reanudamos labores. Cuando empezó el aislamiento preventivo, decidimos detener nuestras actividades; algo preocupante para nosotros.',
    'content' => '
        Es importante para nosotros expresarle a todos nuestros clientes, proveedores y a la población en general, que reanudamos labores. Cuando empezó el aislamiento preventivo, decidimos detener nuestras actividades; algo preocupante para nosotros, pues entendemos que del funcionamiento de Industria de Lácteos La Maporita dependen muchas familias.
        <br><br>Estos tiempos de aislamiento, nos permiten reflexionar sobre todo lo que está pasando alrededor del planeta. Es tiempo de orar a Dios, y de examinar nuestras acciones para con los demás. Este tiempo de aislamiento, nos permite reafirmar nuestro compromiso con el medio ambiente y la ganadería sostenible. El mundo parece haberse detenido, son tiempos difíciles, pero es por el bien de todos.
        <br><br>Hemos reanudado labores, porque es hora de seguir adelante, la vida debe continuar, y desde la Familia Maporita, queremos decirle a todos nuestros clientes: ¡Gracias! Gracias por su compromiso y apoyo en estos momentos de emergencia. Gracias, porque sin su compra, no podríamos apoyar la economía de nuestro municipio.
        <br><br>Hemos tomado las precauciones y nuevamente iniciamos labores, dando ese reconocimiento especial, a aquellos que hacen posible que sigamos adelante.
        <br><br><iframe width="560" height="315" src="https://www.youtube.com/embed/PLKmsgq-tD0?si=7r7Go-MUhhPwNNqf" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
    '
];
