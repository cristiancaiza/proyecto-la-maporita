...
<head>
    ...
    <title>Queso Fiesta || Industria de Lácteos, La Maporita</title>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="breadcaump-inner text-center">
                            <h2 class="heading heading-h2 font-60 text-white">Queso Fiesta</h2>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="nextprev-btn">
                            <div class="navlist">
                                <div class="navitem prev">
                                    <a id="backLink" class="text-white" href="queso-finas-hierbas.php">Anterior</a>
                                </div>
                                <!--
                            ...
                            <div class="product__details__container">
                                <div class="tab_container big_img_container">
                                    <div class="big_img tab-pane fade show active" id="img1" role="tabpanel">
                                        <img class="w-100" src="img/productos/grandes/760-x-760-queso-fiesta.jpg" alt="Queso Fiesta">
                                    </div>
                                </div>
                                <div class="sm_roduct_nav nav nav-tabs" role="tablist">
                                    <a class="active" id="img1-tab" data-bs-toggle="tab" href="#img1" role="tab"
                                        ...
                                        <img src="img/productos/mini/210-x-210-queso-fiesta.jpg" alt="Queso Fiesta">
                                    </a>
                                    <!--
