...
<body class="template-color-39 template-font-1 bg_color--42">
  ...
  <![endif]-->
    ...
    <div id="wrapper" class="wrapper">
        ...
        <div class="brook-breadcaump-area pt--200 pt_md--250 pt_sm--200 pb--200 pb_md--250 pb_sm--200 bg_image--135 breadcaump-title-bar breadcaump-title-white" data-black-overlay='5'>
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="breadcaump-inner text-center">
                            <h2 class="heading heading-h2 font-60 text-white">Información para proveedores</h2>
                        </div>
                    </div>
                </div>
            </div>
