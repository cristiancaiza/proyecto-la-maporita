<?php
$blog_post = [
    'title' => 'Asistencia Técnica, un gran valor agregado',
    'date' => 'Octubre 19, 2018',
    'category' => 'Categoría',
    'image' => 'img/novedades/grandes/asistencia-tecnica-un-gran-valor-agregado-g.jpg',
    'alt' => 'Asistencia Técnica, un gran valor agregado',
    'description' => 'En la familia de Lácteos La Maporita, los proveedores de leche son lo más importante; sin ellos no habría empresa.',
    'content' => '
        En la familia de Lácteos La Maporita, los proveedores de leche son lo más importante; sin ellos no habría empresa. Es por esta razón, que no solo pagamos un precio neto por litro de leche, sino que además, prestamos un apoyo en campo que les permita fortalecer sus hatos ganaderos desde ese acompañamiento en el ordeño, todo lo que tiene que ver al rededor de la sanidad animal y asesoría en la administración de sus fincas.
        <br><br>Hemos logrado llevar este acompañamiento extensivo, gracias a la alianza con la Agropecuaria Los Potrillos, atendiendo a los proveedores, para mejorar la producción que tienen, manejando programas adecuados para que las fincas sean más productivas.
        <br><br>Industria de Lácteos La Maporita, cuenta con el respaldo de la Denominación de Origen Queso del Caquetá, que a través del Comité Departamental de Ganaderos del Caquetá y la Marca Colectiva QC, ha logrado llevar a cabo convenios con programas estructurados, que benefician directamente a los proveedores, para fortalecer la producción de leche óptima y de buena calidad, a la vez que se promueve la conservación del piedemonte amazónico.
        <br><br>A través de la Agropecuaria Los Potrillos, los proveedores reciben promociones en productos, capacitaciones desde la línea veterinaria, línea agrícola, asesoría en potreros, manejo de pasturas y rotación de praderas para que la finca sea más eficiente en la producción de leche, tanto en cantidad como en calidad.
    '
];
