<?php
$blog_post = [
    'title' => 'Visita Davivienda Regional Centro Sur',
    'date' => 'Junio 15, 2022',
    'category' => 'Categoría',
    'image' => 'img/novedades/grandes/visita-davivienda-regional-centro-sur-g.jpg',
    'alt' => 'Visita Davivienda Regional Centro Sur',
    'description' => 'Acciones de integración de cadena y sostenibilidad ganadera, tras el establecimiento del "ECOSISTEMA FINANCIERO" en beneficio de los ganaderos del Caquetá',
    'content' => '
        El pasado martes 14 de junio, el equipo de ejecutivos del Banco Davivienda Regional Centro Sur, en cabeza de su Gerente la Dra. Natalia Rangel Arenas, visitaron nuestra planta, con el objeto de comprobar nuestras acciones de integración de cadena y sostenibilidad ganadera, tras el establecimiento del "ECOSISTEMA FINANCIERO" en beneficio de los ganaderos del Caquetá, para generar una mejor leche, sostenible y de alta calidad. Es una gran noticia para el principal activo de la empresa: nuestros Ganaderos proveedores.
        <br><br>Muy agradecidos por su decisión y empeño.
    '
];
